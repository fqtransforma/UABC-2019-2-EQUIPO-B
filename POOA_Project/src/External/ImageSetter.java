...
public class ImageSetter {
    ...
    public static void loadImages(){
        try{
            ...
            trashSheet = BIL.loadImage("res/trash3.png");
        }catch (IOException e){
            e.printStackTrace();
        }
        ...
        organic = tSheet.grabImage(1,1,24,16);
        aluminum = tSheet.grabImage(1,2,24,16);
        plastic = tSheet.grabImage(1,3,24,16);
        cardboard = tSheet.grabImage(1,4,24,16);
    }
}
